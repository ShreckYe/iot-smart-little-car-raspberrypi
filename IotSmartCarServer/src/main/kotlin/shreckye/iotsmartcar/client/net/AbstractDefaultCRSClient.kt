...
abstract class AbstractDefaultCRSClient<Image>(
    ...
    val streamClient = object : AbstractStreamClient<Image>(imageReceivedListener, recognitionPredictionsReceivedListener, host) {
    ...
    fun capture(reqeust: IotSmartCarProto.CaptureRequest, responseObserver: StreamObserver<IotSmartCarProto.CaptureResponse>) = reliableClient.capture(reqeust, responseObserver)
    fun getPhotoList(request: IotSmartCarProto.GetPhotoListRequest, responseObserver: StreamObserver<IotSmartCarProto.PhotoItem>) = reliableClient.getPhotoList(request, responseObserver)
